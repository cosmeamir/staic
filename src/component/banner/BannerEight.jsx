                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="banner-seven-main-wrapper">
                                    <span className="pre-title" data-aos="move-right" data-aos-delay="0">STA</span>
                                    <h1 className="title rts_hero__title" data-aos="move-right" data-aos-delay="100">
                                        <span className="top">INTERNATIONAL</span> <br />
                                        <span className="bottom-right">Consultltants</span>
                                        <img
