                    ...
                    <div className="row mt--0 g-5">
                        <div className="col-lg-4 col-md-6">
                            <div className="left-contact">
                                <p className="top mb--30">Building the Future with  &amp; Knowledge and Precision</p>
                                <p className="disc mb--20">
                                    TEXTO
                                </p>
                                <a href="#">Hot Line: +999 9999 999</a>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 pl--50 pl_md--15 pl_sm--15">
                            <div className="contact-info-mid">
                                ...
                                <div className="single-information">
                                    <span>Phone:</span>
                                    <a href="Tel:123-456-7890">+000 00000</a>
                                </div>
                                <div className="single-information">
                                    <span>Mail:</span>
                                    <a href="mailto:webmaster@example.com">email@exemplo.com</a>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6">
